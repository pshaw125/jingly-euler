...
import com.rhejinald.euler.lib.cards.Card;
import com.rhejinald.euler.lib.cards.PokerHand;
 ...
 * ....
 * <p>
 * [Given the input], How many hands does Player 1 win?
 * <p>
 * ======================
 * <p>
...
public class Problem54Incomplete {
    ...
    @Test
    public void testSampleHand() throws Exception {
        String[] cardStrings = "8C TS KC 9H 4S 7D 2S 5D 3S AC".split(" ");
        PokerHand hand1 = nomCards(cardStrings, 0, 4);
        PokerHand hand2 = nomCards(cardStrings, 5, 9);

        assertThat(hand1.getCards()).containsOnly(
                new Card(8, CLUB),
                new Card(10, SPADE),
                new Card(13, CLUB),
                new Card(9, HEART),
                new Card(4, SPADE));
        assertThat(hand2.getCards()).containsOnly(
                new Card(7, DIAMOND),
                new Card(2, SPADE),
                new Card(5, DIAMOND),
                new Card(3, SPADE),
    ...
    private PokerHand nomCards(String[] cardStrings, int startIndex, int endIndex) {
        ArrayList<Card> hand = Lists.newArrayList();
